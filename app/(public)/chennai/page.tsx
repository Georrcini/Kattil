...
const localBusinessJsonLd = {
  ...
  description:
    "Kattil Chennai offers premium co-living and hotel rooms in Teynampet, one of Chennai's most connected neighbourhoods. High-speed Wi-Fi, AC rooms, and curated community spaces.",
  address: {
    "@type": "PostalAddress",
...
export const metadata: Metadata = {
  title: "Hotel in Chennai | Kattil — Homely Stay in Teynampet",
  description:
    "Stay at Kattil Chennai — a premium hotel in Teynampet offering AC rooms, co-working spaces, and warm hospitality. Ideal for travellers, professionals, and digital nomads.",
  keywords: [
    "hotel in Chennai",
    ...
    "co-living Chennai",
    "Kattil Chennai",
    "budget hotel Chennai",
    "premium hostel Chennai",
  ],
  alternates: {
    canonical: `${SITE_URL}/chennai`,
  },
  openGraph: {
    title: "Kattil Chennai — Homely Hotel in Teynampet",
    description:
      "Premium AC rooms and co-working spaces in the heart of Chennai. Book your stay at Kattil today.",
    url: `${SITE_URL}/chennai`,
    images: [{ url: "/assets/gallery.png", width: 1200, height: 630, alt: "Kattil Chennai Hotel" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Kattil Chennai — Homely Hotel",
    description: "Premium stay in Teynampet, Chennai. Book now.",
    images: ["/assets/gallery.png"],
  },
};

const features = [
  { label: "Prime Location", desc: "Teynampet — close to IT corridors, metro, and city landmarks" },
  { label: "AC Rooms", desc: "Private doubles and shared dormitories with individual pod cooling" },
  { label: "High-Speed Wi-Fi", desc: "Fibre broadband across all rooms and co-working areas" },
  { label: "24/7 Support", desc: "Our team is always on-site to assist you" },
];
      ...
      <section className="bg-secondary pt-28 md:pt-36 lg:pt-44 pb-16 md:pb-20">
        <div className="mx-auto max-w-480 px-5 md:px-8 lg:px-20">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-[3.2rem] font-normal text-white leading-[1.08] tracking-tight mb-6 max-w-2xl">
            Your Home in the Heart of Chennai
          </h1>
          <p className="font-sans text-base text-white/70 leading-relaxed max-w-xl mb-10">
            Located in Teynampet — one of Chennai's most connected neighbourhoods — Kattil offers
            premium AC rooms, dedicated co-working spaces, and a warm community that makes every
      ...
      <section className="bg-tertiary py-14 md:py-20">
        <div className="mx-auto max-w-480 px-5 md:px-8 lg:px-20">
          <h2 className="font-serif text-2xl md:text-3xl font-normal text-primary tracking-tight mb-10">
            What Makes Kattil Chennai Special
          </h2>
          ...
          <div className="bg-secondary rounded-2xl px-8 py-10 md:px-12 md:py-12">
            <h2 className="font-serif text-2xl md:text-3xl font-normal text-white mb-5">
              Explore Chennai From Our Doorstep
            </h2>
            <p className="font-sans text-base text-white/70 leading-relaxed mb-6 max-w-2xl">
              Teynampet puts you minutes from Chennai's top business districts, Marina Beach,
              Kapaleeshwarar Temple, and the city's best dining. Whether you're here for work or
              leisure, Kattil Chennai is your perfect base.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {["Marina Beach — 20 min", "Chennai Central Station — 15 min", "IT Corridor — 25 min"].map((item) => (
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-base text-primary font-medium">
                Plot 12, Cenotaph Road, Teynampet, Chennai, Tamil Nadu 600018
              </p>
            </div>
            <a
